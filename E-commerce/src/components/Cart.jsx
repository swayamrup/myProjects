...
function Cart() {
  ...
  return (
    <>
    {isLogin?<div className="dark:text-[#dce1fd] dark:bg-[#2d2f36]">
    {cart.length <= 0 ? (
            ...
            {cart.map((cartItem) => (
              ...
              >
                ...
                <div className="right  min-w-48 sm:min-w-56">
                  ...
                  <span>₹{cartItem.discountPrice.toLocaleString("en-IN")}</span>
                </div>
                <div
          ...
          <div className="order ">
            <div className="priceDetails p-2 m-2 border rounded-md min-w-[350px] self-start  ">
              ...
              <div className="SecuredPackegeFee flex justify-between">
                ...
                <span className="">₹ {cartSummery.securedPackegeFee}</span>
              </div>
              ...
              <div className="text-green-400">
                You will save ₹{cartSummery.totalSaving.toLocaleString()} on
                this order
              </div>
            </div>
    ...
    </div>:<h1 className="cursor-pointer" onClick={()=>navigate("/login")}>plese login first...</h1>}
    </>
  );
}
